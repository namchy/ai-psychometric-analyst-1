...
ALTER FUNCTION "public"."get_active_prompt_version"("p_test_id" "uuid", "p_report_type" "text", "p_audience" "text", "p_source_type" "text", "p_generator_type" "text", "p_prompt_key" "text") OWNER TO "postgres";
...
REVOKE ALL ON FUNCTION "public"."get_active_prompt_version"("p_test_id" "uuid", "p_report_type" "text", "p_audience" "text", "p_source_type" "text", "p_generator_type" "text", "p_prompt_key" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_active_prompt_version"("p_test_id" "uuid", "p_report_type" "text", "p_audience" "text", "p_source_type" "text", "p_generator_type" "text", "p_prompt_key" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_active_prompt_version"("p_test_id" "uuid", "p_report_type" "text", "p_audience" "text", "p_source_type" "text", "p_generator_type" "text", "p_prompt_key" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_active_prompt_version"("p_test_id" "uuid", "p_report_type" "text", "p_audience" "text", "p_source_type" "text", "p_generator_type" "text", "p_prompt_key" "text") TO "service_role";
