      ...
      return JSON.stringify({
        instructions: {
          ...
          field_level_rules: [
            ...
            "interpretationLimits must also make clear that this report is not a hiring decision, that SAFRAN is not IQ, norma or percentil, and that the cognitive signal is a hypothesis for checking rather than a final conclusion.",
          ],
          structure_rules: [
            "Return valid JSON only.",
            ...
            "executiveSummary.summary must be 2 sentences or fewer.",
            ...
            "At least one interpretationLimits item must say that SAFRAN is not IQ, norma or percentil.",
