      ...
      return JSON.stringify({
        instructions: {
          ...
          structure_rules: [
            ...
            "At least one interpretationLimits item must say that the result should not be used for ranking a person against others or read as a comparison with a wider population.",
