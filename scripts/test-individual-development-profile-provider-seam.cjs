...
async function main() {
  ...
  for (const pattern of [
    ...
    /Assessment findings are evidence, not the final narrative/,
    /Do not imitate the wording, order, caution pattern or technical language of the input snapshot/,
    /postepena izloženost grupnim situacijama/,
    /Write as a senior HR development advisor/,
    /premium HR synthesis/,
    /developmentSummary\.headline/,
    /developmentSummary\.overallPattern/,
    /developmentSummary\.strongestContributionSignals/,
    /do not use “vjerovatno”/,
    /Avoid “može” and “mogu” as hedge words/,
    /Section usefulness rule/,
    /Concrete workplace language/,
    /Bad:/,
    /Good:/,
    /perfekcionističko usporavanje/,
    /usporavanje prve verzije zbog dodatne provjere kvaliteta/,
    /spontana rasprava/,
    /The headline must be short, direct/,
    /pažljivo kalibrisana brzina isporuke/,
    /kanali za doprinos/,
    /kanale za doprinos/,
    /kanal za doprinos/,
    /dogovorena uloga u timskom radu/,
    /jasno mjesto doprinosa u timu/,
    /verbalna prisutnost/,
    /Profil upućuje na osobu/,
    /Interpretation limits must be present/,
  ]) {
