...
\restrict nwuCvFQQA6eTEbsgkAubF62S4M20zw5URGExDfYDs5SkOKekdfYsplzz68tcSsI
...
ALTER TABLE public.keepalive ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: keepalive Allow anon delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow anon delete" ON public.keepalive FOR DELETE USING (true);


--
-- Name: keepalive Allow anon insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow anon insert" ON public.keepalive FOR INSERT WITH CHECK (true);


--
-- Name: keepalive Allow anon select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow anon select" ON public.keepalive FOR SELECT USING (true);
...
\unrestrict nwuCvFQQA6eTEbsgkAubF62S4M20zw5URGExDfYDs5SkOKekdfYsplzz68tcSsI
