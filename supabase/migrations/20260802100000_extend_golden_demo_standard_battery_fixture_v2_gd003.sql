-- Forward-only GD-003 extension of the candidate-aware Golden Demo standard-battery fixture RPC.
...
begin
  ...
  if p_fixture ->> 'schema_version' is distinct from 'gd_db_fixture_v1'
    ...
    or v_candidate_id not in ('GD-001', 'GD-002', 'GD-003')
  ...
  -- GD-002 and GD-003 must already exist; GD-001 may be created by this generic seam
  ...
  elsif v_candidate_id in ('GD-002', 'GD-003') then
