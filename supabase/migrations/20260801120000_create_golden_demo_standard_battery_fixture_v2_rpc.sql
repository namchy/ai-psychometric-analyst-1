-- Candidate-aware Golden Demo standard-battery fixture creation.
-- This function is intentionally EMPTY-only: it never repairs, upserts,
-- overwrites, scores, reports, or touches the separate Team Dynamics lane.
...
begin
  ...
  if p_fixture ->> 'schema_version' is distinct from 'gd_db_fixture_v1'
    ...
    or v_candidate_id not in ('GD-001', 'GD-002')
  ...
  -- GD-002 must already exist; GD-001 may be created by this generic seam
  ...
  if v_participant_id is not null then
    ...
    raise exception 'GD_FIXTURE_INVALID: GD-002 requires an existing canonical participant.';
  end if;
