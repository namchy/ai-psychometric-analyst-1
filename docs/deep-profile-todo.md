...
**Sljedeći korak:**  
Team Dynamics aggregation persistence lifecycle hardening: dokumentovati i testno zaključati kada se aggregation snapshot smije kreirati/osvježiti, kako se tretira stale stanje nakon promjene member score snapshota i koji helper/path je odgovoran za recalculation, bez UI prikaza, bez report orchestration-a, bez attempt_reports, bez assessment_reports, bez AI/report generation-a i bez Team Fit outputa.
