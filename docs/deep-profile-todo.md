...
| P1        | Golden Demo Cohort and AI report calibration | Active | Demo data / Report QA / Calibration | Partner Plus demo identitet, 24 korisnika, GD-001 fixture i production scoring su zaključani (`SCORED_EXACT`, 184/184 raw/scored, 40 dimensions, 47/47 expected). Sljedeći: report-generation/AI audit i zaseban operator plan; ne ponavljati scoring. |
