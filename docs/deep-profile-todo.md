...
| P1        | Timski fit kandidata product/report contract spec | Contract/validator shell implemented / no provider/renderer/worker | Relacijski report / Candidate-team fit | Next slice: Team Fit mock-safe generation shell or provider seam, only after explicit approval. |
