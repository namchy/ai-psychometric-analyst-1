...
| P0        | Golden Team individual data and report completeness  | Aktivno — GD-003 sljedeći | Golden Demo / Cohort data | Read-only source/profile/fixture audit za GD-003; zatim authored potvrda, fixture completeness, offline exact provjera, controlled persistence, scoring, report paket i completeness verification. |
