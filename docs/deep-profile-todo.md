...
| P1        | Timski fit kandidata product/report contract spec | Input snapshot builder shell implemented / no provider/renderer/worker | Relacijski report / Candidate-team fit | Next slice: Team Fit contract/validator shell or mock-safe generation shell, only after explicit approval. |
