...
> **Precondition za GD-006–GD-018 cohort runner:** prije širenja cohort runnera obavezno uvesti AI usage/cost instrumentation za input, cached, output, reasoning i total tokene; model i reasoning level; provider request ID; trajanje, status i pokušaj; verzionirani AI cjenovnik; te historijski procijenjeni trošak po pozivu, reportu i kandidatu. Super Admin analytics UI za `zadnjih 10 / 20 / 50 / sve` dolazi kasnije i koristi ove podatke; dashboard nije dio ovog taska.
>
> **GDT-01 cohort status:** `GD-001: complete hero package`; `GD-002: complete individual package`; `GD-003: COMPLETE — package completeness verified`; `GD-004: COMPLETE — 5/5 READY_VALID measured report package`; `GD-005: COMPLETE — 5/5 READY_VALID measured report package`; `GD-019: untouched holdout`. Team Dynamics lane ostaje završen i ne mijenja se ovim handoffom.
>
