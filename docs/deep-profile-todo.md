...
| P1        | Timski fit kandidata product/report contract spec | Spec decision draft refined / key MVP questions closed | Relacijski report / Candidate-team fit | Docs-only canonicalization: pretvoriti refined Team Fit decision draft u canonical product/report contract spec zapis ili zaseban spec dokument. Bez DB/provider/renderer/worker rada. |
