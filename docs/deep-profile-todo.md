...
| P1        | Timski fit kandidata product/report contract spec | Renderer shell implemented / no route action provider worker | Relacijski report / Candidate-team fit | Next slice after pause: Team Fit read-only route shell + visual fixture, only after explicit approval. No OpenAI/provider/action/worker yet. |
